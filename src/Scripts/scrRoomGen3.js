...
*/
  ...
  if (
    ...
    strTemp =
      '00000000000000000000000000000000000000000008000000000000000000000000001111111111';
  } else if (roomPath == 0 && rand(1, 2) == 1) {
    // side room
    if (!oGame.altar && rand(1, 12) == 1) {
      n = 10;
      oGame.altar = true;
    } else if (oGame.idol) {
      n = rand(1, 8);
    ...
    switch (n) {
      ...
      case 4: {
        strTemp =
          '0000000000000211200000011110000001111000001111000002222000000000000000000000';
        break;
      }
      case 5: {
        strTemp =
          '000000000000000000000022002200001111000011001200202100120220210012020002002000';
        break;
      }
      case 6: {
        strTemp =
      ...
      case 9: {
        strTemp =
          '00000000000000I000000000cc000000000000000000000000000000000000007700000000110000';
        break;
      }
      // altars
      case 10: {
    ...
    (roomPath == 0 || roomPath == 1 || roomPath == 2) &&
    rand(1, 10) < 10
  ) {
    switch (rand(1, 9)) {
      // basic rooms
      case 1: {
        strTemp =
          '00000000000000000000000000000000006000000000000000000000000000021111120000222220';
        break;
      }
      case 2: {
        strTemp =
          '00000000000000000000000000000060000000000000000000000000000021111120000222220000';
        break;
      }
      case 3: {
        strTemp =
          '11111200001111112000111111200000002120001120000000112021200000001120001111120000';
        break;
      }
      case 4: {
        strTemp =
          '00002111110002111111000211111100021200000000000211000212021100021100000000211111';
        break;
      }
      case 5: {
        strTemp =
          '000000000000000000jj002100iii00021000000002111iii000021111100000222220000000000';
        break;
      }
      // falling platforms
      case 6: {
        strTemp =
          '00000000000000000000000000000000000000000000000000F00F00F00000000000000000000000';
        break;
      }
      // icy
      case 7: {
    ...
    // shop
    strTemp =
      '111111111111111111111111221111111l000211...000W010...00000k0..K$$$$000::::::::::';
    ...
    switch (rand(1, 7)) {
      ...
      case 6: {
        shopType = 'Craps';
        strTemp =
          '11111111111111111111111122111111Kl000211..:Q00W010.0+00000k0.q+uu00000::::::::::';
        break;
      }
      case 7: {
        shopType = 'Kissing';
        strTemp =
          '111111111111111111111111221111111l000211...000W010...00000k0..K00!0000::::::::::';
        oGame.damsel = true;
        break;
      }
    }
    ...
    // shop
    strTemp =
      '111111111111111111111111221111112000l11101W0000...0k00000...000$$$$K..::::::::::';
    ...
    switch (rand(1, 7)) {
      ...
      case 6: {
        shopType = 'Craps';
        strTemp =
          '111111111111111111111111221111112000lK1101W0Q00:..0k00000+0.00000uu+q.::::::::::';
        break;
      }
      case 7: {
        shopType = 'Kissing';
        strTemp =
          '111111111111111111111111221111112000l11101W0000...0k00000...0000!00K..::::::::::';
        oGame.damsel = true;
        break;
      }
    }
    ...
    switch (rand(1, 2)) {
      case 1: {
        strTemp =
          '000000000000000M000000000000000000000000021110002002111mmm2000111111000000000000';
        break;
      }
      case 2: {
        strTemp =
          '000000000000M000000000000000000000000000020001112002mmm1112000111111000000000000';
        break;
      }
    }
  } else if (roomPath == 7)
    strTemp =
      '0000000000000DAAAAAA0iiiE0E0E00iG00000000C00000000000000000000BBBBBBBB0000000000';
  else if (roomPath == 8)
    strTemp =
      '0000000000AAAAAAAAAAE0E0E0E0E0000000000000000000000000000000BBBBBBBBBB0000000000';
  else if (roomPath == 9)
    strTemp =
      '0000022221AAAAAAAAA1E0E0Et2211000000X01100000000T1000022ii11BBBbbbbbbb0000222221';
  else
    strTemp =
      '00000000000000000000000000000000005000000000000000000000000000021111120000222220';
  ...
  for (j = 0; j < 8; j += 1) {
    for (i = 1; i < 11; i += 1) {
      ...
      if (tile == '1' && !collision_point(xpos, ypos, oSolid, 0, 0)) {
        ...
        if (rand(1, 3) == 1)
          tile_add(bgAlienShip, 32, 0, 32, 64, xpos, ypos, 9005);
      ...
      } else if (tile == 'M' && !collision_point(xpos, ypos, oSolid, 0, 0)) {
