...
// scrInit()
//
// Initialize the game (mostly controls && audio).
//
...
if (file) {
  ...
  if (str == '0') global.ullscreen = false;
...
// if (!joystick_exists(1) && ! joystick_exists(2)) global.gamepadOn = false;
//Spelunky 1.2 7-3-2012 Switch to soft fullscreen if screenScale is 5 (scale up to resolutions) && fullscreen off
global.softfullscreen = 0;
if (global.ullscreen == 0 && global.screenScale == 5) global.softfullscreen = 1;
