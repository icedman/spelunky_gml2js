...
if (global.drawHUD && instance_exists(oPlayer1)) {
  lifeX = 8;
  bombX = 64;
  ropeX = 120;
  moneyX = 176;
    ...
    if (global.exitY > view_yview[0] + 240) {
      if (global.exitX < view_xview[0]) {
        ...
        if (global.messageTimer > 0)
          draw_sprite(sCompassSmallDown, -1, global.exitX - view_xview[0], 224);
        else draw_sprite(sCompassDown, -1, global.exitX - view_xview[0], 224);
      }
    } else if (global.exitX < view_xview[0]) {
      if (global.messageTimer > 0)
        draw_sprite(sCompassSmallLeft, -1, 0, global.exitY - view_yview[0]);
      else draw_sprite(sCompassLeft, -1, 0, global.exitY - view_yview[0]);
    } else if (global.exitX > view_xview[0] + 320 - 16) {
      if (global.messageTimer > 0)
        draw_sprite(sCompassSmallRight, -1, 304, global.exitY - view_yview[0]);
  ...
  if (oPlayer1.pickupItemType != '') {
    if (oPlayer1.pickupItemType == 'Rock')
      draw_sprite(sRock, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Jar')
      draw_sprite(sJar, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Skull')
      draw_sprite(sSkull, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Fish Bone')
      draw_sprite(sFishBone, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Arrow')
      draw_sprite(sArrowRight, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Machete')
      draw_sprite(sMacheteRight, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Mattock')
      draw_sprite(sMattockRight, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Mattock Head')
      draw_sprite(sMattockHead, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Pistol')
      draw_sprite(sPistolRight, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Web Cannon')
      draw_sprite(sWebCannonR, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Teleporter')
      draw_sprite(sTeleporter, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Shotgun')
      draw_sprite(sShotgunRight, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Bow')
      draw_sprite(sBowDisp, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Sceptre')
      draw_sprite(sSceptreRight, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Flare')
      draw_sprite(sFlare, -1, 8 + 8, 24 + 8);
    else if (oPlayer1.pickupItemType == 'Key')
      draw_sprite(sKeyRight, -1, 8 + 8, 24 + 8);
  }
  ...
  if (global.collect > 0)
    draw_text(moneyX, 8 + 16, '+' + string(global.collect));
}
