...
if (
  ...
  switch (n) {
    ...
    case 5: {
      strTemp =
        '000000000000000900000221111220wwvvvvvvwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww';
      break;
    }
  }
} else if (roomPath == 0 && rand(1, 3) <= 2) {
  // side room
  ...
  switch (n) {
    ...
    case 7: {
      strTemp =
        '000000000011wwwwww1111wwwwww11113wwww311113wwww311113wwww31111133331111111111111';
      break;
    }
    case 8: {
      strTemp =
        '00000000000000rr0000000rttr00000rrrrrr0000V0000000000000000000000000000000000000';
      break;
    }
    // idols
    case 9: {
      if (global.cemetary)
        strTemp =
          'ttttttttttttttttttttttp0C00pttttt0tt0ttt4000000004ttt0tt0tttttp0000ptt1111111111';
      else
        strTemp =
          '01000000100000I0000001BBBBBB10110000001111wwwwww1111wwwwww11113wwww3111111111111';
      break;
    }
    // altars
    case 10: {
  ...
  switch (rand(1, 8)) {
    ...
    case 3: {
      strTemp =
        'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww,,wwwwww,,wwwwwwwwwwwwwwwwwwww,,,,,,,,,,';
      break;
    }
    case 4: {
      strTemp =
        'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww,v,wwwwwwwwwv,wwwwwww,v,wwwwww,,v,,,,,ww';
      break;
    }
    case 5: {
      strTemp =
        'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww,v,wwwwww,vwwwwwwww,v,ww,,,,,,v,,';
      break;
    }
    case 6: {
      strTemp =
        'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww,,wwwwwww,vv,wwwwww,vv,wwwww,,vv,,ww,,,vvvv,,,';
      break;
    }
    case 7: {
      strTemp =
        'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww,,,,wwwww,vvvv,www,v,w,vv,ww,wwww,vv,,,,,,,,,,,';
      break;
    }
    case 8: {
      strTemp =
        'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww,,,,wwwww,vvvv,www,vv,w,v,w,vv,wwww,w,,,,,,,,,,';
      break;
    }
  }
} else if (roomPath == 8) {
  ...
  // Mega Mouth
  strTemp =
    'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwJwwwwwwwwwwwwwwwwwwwwwwwwww,,,,,,,,,,';
} // drop
else {
  ...
  switch (n) {
    case 1: {
      strTemp =
        '00000000000000000000000000000000000000000000000000000000002200000002111111202111';
      break;
    }
    case 2: {
      strTemp =
        '000000000000000000000000000000000000000000000000002200000000112T0000001111202111';
      break;
    }
    case 3: {
      strTemp =
    ...
    case 4: {
      strTemp =
        '00000000000000000000000000000000000000000000000000000000000020000222221000111111';
      break;
    }
    case 5: {
      strTemp =
        '00000000000000000000000000000000000000000000000000000000000022222000021111110001';
      break;
    }
    //
    case 6: {
...
for (j = 0; j < 8; j += 1) {
  for (i = 1; i < 11; i += 1) {
    ...
    if (tile == 't' && !collision_point(xpos, ypos, oSolid, 0, 0)) {
      instance_create(xpos, ypos, oTemple);
    }
    if (tile == 'r' && !collision_point(xpos, ypos, oSolid, 0, 0)) {
