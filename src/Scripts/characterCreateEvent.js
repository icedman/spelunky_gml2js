...
*/
  ...
  state = FALLING; // the character state, must be one of the following: STANDING, RUNNING, DUCKING, LOOKING_UP, CLIMBING, JUMPING, || FALLING
  facing = RIGHT; // which direction the character is facing, must be either LEFT || RIGHT
  ...
  jumps = 0;
  flySpeed = 0; //ranges between 0 && 100. When the flySpeed is approximately 100, the character can "fly."
  flySpeedTimer = 0;
  flyAccTimer = 0;
  flyAcc2Timer = 0;
  flyJumpsTimer = 0;
