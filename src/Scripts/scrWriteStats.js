...
***********************************************************************************/
  ...
  for (i = 0; i < 16; i += 1) {
    if (i + 1 < 10)
      file_text_write_string(file, ' ' + string(i + 1) + '          | ');
  ...
  for (i = 0; i < 24; i += 1) {
    if (global.enemyDeaths[i] == 0)
      file_text_write_string(file, ' ???        | ');
    else {
      switch (i) {
        case 0: {
          file_text_write_string(file, ' BAT        | ');
          break;
        }
        case 1: {
          file_text_write_string(file, ' SNAKE      | ');
          break;
        }
        case 2: {
          file_text_write_string(file, ' SPIDER     | ');
          break;
        }
        case 3: {
          file_text_write_string(file, ' G. SPIDER  | ');
          break;
        }
        case 4: {
          file_text_write_string(file, ' CAVEMAN    | ');
          break;
        }
        case 5: {
          file_text_write_string(file, ' SKELETON   | ');
          break;
        }
        case 6: {
          file_text_write_string(file, ' ZOMBIE     | ');
          break;
        }
        case 7: {
          file_text_write_string(file, ' VAMPIRE    | ');
          break;
        }
        case 8: {
          file_text_write_string(file, ' FROG       | ');
          break;
        }
        case 9: {
          file_text_write_string(file, ' FIRE FROG  | ');
          break;
        }
        case 10: {
          file_text_write_string(file, ' MANTRAP    | ');
          break;
        }
        case 11: {
          file_text_write_string(file, ' PIRANHA    | ');
          break;
        }
        case 12: {
          file_text_write_string(file, ' MEGAMOUTH  | ');
          break;
        }
        case 13: {
          file_text_write_string(file, ' YETI       | ');
          break;
        }
        case 14: {
          file_text_write_string(file, ' YETI KING  | ');
          break;
        }
        case 15: {
          file_text_write_string(file, ' ALIEN      | ');
          break;
        }
        case 16: {
          file_text_write_string(file, ' UFO        | ');
          break;
        }
        case 17: {
          file_text_write_string(file, ' ALIEN BOSS | ');
          break;
        }
        case 18: {
          file_text_write_string(file, ' HAWKMAN    | ');
          break;
        }
        case 19: {
          file_text_write_string(file, ' SHOPKEEPER | ');
          break;
        }
        case 20: {
          file_text_write_string(file, ' TOMB LORD  | ');
          break;
        }
        case 21: {
          file_text_write_string(file, ' MAGMA MAN  | ');
          break;
        }
        case 22: {
          file_text_write_string(file, ' OLMEC      | ');
          break;
        }
        case 23: {
          file_text_write_string(file, ' GHOST      | ');
          break;
        }
      }
    }
  ...
  for (i = 0; i < 12; i += 1) {
    if (global.miscDeaths[i] == 0)
      ...
      switch (i) {
        ...
        case 1: {
          file_text_write_string(file, ' EXPLOSION  | ');
          break;
        }
        case 2: {
          file_text_write_string(file, ' CRUSHED    | ');
          break;
        }
        case 3: {
          file_text_write_string(file, ' LONG FALL  | ');
          break;
        }
        case 4: {
          file_text_write_string(file, ' SPIKES     | ');
          break;
        }
        case 5: {
          file_text_write_string(file, ' BOULDER    | ');
          break;
        }
        case 6: {
          file_text_write_string(file, ' ARROW TRAP | ');
          break;
        }
        case 7: {
          file_text_write_string(file, ' SPEAR TRAP | ');
          break;
        }
        case 8: {
          file_text_write_string(file, ' SMASH TRAP | ');
          break;
        }
        case 9: {
          file_text_write_string(file, ' CEILING T. | ');
          break;
        }
        case 10: {
          file_text_write_string(file, ' PIT        | ');
          break;
        }
        case 11: {
          file_text_write_string(file, ' LAVA       | ');
          break;
        }
      }
    }
