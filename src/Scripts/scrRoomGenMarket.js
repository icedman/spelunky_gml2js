...
if (
...
} else if (roomPath == 4 && x == 496) {
  // shop
  strTemp =
    '0000000011.....b0AlK......bbbb..........1111111111111111111111111111111111111111';
  shopType = 'Ankh';
} else if (roomPath == 4) {
  // shop
  strTemp =
    '........................22......2l00l2..0.000000.00k000000k0000iiiiK00bbbbbbbbbb';
  ...
  while (shopType == '') {
    if (n == 1) {
      if (!oGame.genSupplyShop) {
        shopType = 'General';
        oGame.genSupplyShop = true;
      }
    } else if (n == 2) {
      if (!oGame.genBombShop) {
        shopType = 'Bomb';
        oGame.genBombShop = true;
      }
    } else if (n == 3) {
      if (!oGame.genWeaponShop) {
        shopType = 'Weapon';
        oGame.genWeaponShop = true;
      }
    } else if (n == 4) {
      if (!oGame.genRareShop) {
        shopType = 'Rare';
        oGame.genRareShop = true;
      }
    } else if (n == 5) {
      if (!oGame.genClothingShop) {
        shopType = 'Clothing';
        oGame.genClothingShop = true;
      }
    }
    n += 1;
    if (n > 5) n = 1;
  ...
  // casino
  strTemp =
    '111111111111111111111111221111112000lK1101W0Q00b..0k00000+0.00000zz+q.bbbbbbbbbb';
  shopType = 'Craps';
} // drop
else {
  ...
  switch (n) {
    case 1: {
      strTemp =
        '00G000000000H111100000G222200000G000000000G000000000G000002200000002111111202111';
      break;
    }
    case 2: {
      strTemp =
        '0000000G000001111H000002222G000000000G000000000G002200000G00112T0000001111202111';
      break;
    }
    case 3: {
      strTemp =
        '00000000G060000011H000000000G000000000G0G0000000G0H1122000G0G0000000G011100001H1';
      break;
    }
    case 4: {
      strTemp =
        '0000000G000001111H000002222G000000000G000000000G00000000000020000222221000111111';
      break;
    }
    case 5: {
      strTemp =
        '00G000000000H111100000G222200000G000000000G0000000000000000022222000021111110001';
      break;
    }
    //
    case 6: {
